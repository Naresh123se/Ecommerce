      ...
      >
        {slides.map((slide) => (
          <div
            ...
            key={slide.id}
          >
            <div className="h-1/2 lg:w-1/2 xl:h-full flex flex-col  items-center justify-center gap-8 xl:gap-12 text-center">
            ...
            {/*  */}
            <div className="h-1/2  xl:h-full lg:w-1/2 relative">
              <Image
                src={slide.img}
                alt=""
                fill
